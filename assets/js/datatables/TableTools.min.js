...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Add a message at the bottom of the page */
		if ( oConfig.sFooterMessage )
		{
			var len = document.body.childNodes.length;
			this.dom.print.message = document.createElement( "div" );
			this.dom.print.message.className = this.classes.print.message;
			this.dom.print.message.innerHTML = oConfig.sFooterMessage;
			$(".dataTables_wrapper").append($(this.dom.print.message));
		//	document.body.insertAfter( this.dom.print.message, document.body.childNodes[len-1] );
		}
