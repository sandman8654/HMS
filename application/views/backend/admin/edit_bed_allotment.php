        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/bed_allotment/update/<?php echo $row['bed_allotment_id']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <select name="bed_id" class="form-control">
                                    ...
                                    <?php foreach ($bed_info as $row2) { ?>
                                        <option value="<?php echo $row2['bed_id']; ?>" <?php if ($row['bed_id'] == $row2['bed_id']) echo 'selected'; ?>>
                                            <?php echo get_phrase($row2['type'])."-".$row2['room_no']."-". $row2['bed_number']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
