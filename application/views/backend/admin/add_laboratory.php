                                    ...
                                    <form role="form" class="form-horizontal form-groups-bordered">
                                       ...
                                       <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select  id="sampleselect" name="items_group" class="form-control" >
                                                    <option value="" selected ><?php echo get_phrase('selecet_sample_name');?></option> 
                                                    <?php 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" name="test_condition" class="form-control" id="test_condition" value="" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="field-ta" class="col-md-3 control-label"><?php echo get_phrase('rejected/Accepted')."*:"; ?></label>
                                            <div class="col-md-7">
                                                <select  id="raselect" name="raselect" class="form-control" >
                                                    <option value="0" selected ><?php echo get_phrase('accepted');?></option> 
                                                    <option value="1"  ><?php echo get_phrase('rejected');?></option> 
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <select  id="raselect" name="raselect" class="form-control" >
                                                    <option value="0" selected ><?php echo get_phrase('outpatient');?></option> 
                                                    <option value="1"  ><?php echo get_phrase('male_ward');?></option> 
                                                    <option value="1"  ><?php echo get_phrase('male_ward');?></option> 
                                                    <option value="1"  ><?php echo get_phrase('maternity');?></option> 
                                                    <option value="1"  ><?php echo get_phrase('paediatrics');?></option> 
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" name="other_details" class="form-control" id="other_details" value="" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
