<?php
$single_accountant_info = $this->db->get_where('admin', array('admin_id' => $param2))->result_array();
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_administrator'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/admin/update/<?php echo $row['admin_id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input disabled type="text" name="name" class="form-control" id="field-1" value="<?php echo $row['user_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-3 control-label col-sm-offset-2">
                            ...
                            <a href="<?php echo base_url().'index.php?admin/admin';?>" class="btn btn-danger btn-md">Exit</a>
                        </div>
                    </form>
