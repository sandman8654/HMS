<div class="row">
    <div class="col-sm-12">
        <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?report/grc_report" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    jQuery(window).load(function ()
    {
        ...
        $("#print-view").on("click",function(e){
            ...
            window.open("<?php echo base_url(); ?>"+"index.php?report/grc_report/print_view/"+"<?php echo $type.'/'.strtotime($from).'/'.strtotime($to); ?>"+"/"+option);
        });
