            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('add_laboratory_request'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/labreq/create" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-9">
                                <select required id="patient-select" name="pinfo" class="form-control " placeholder=<?php echo get_phrase('type_search_patient');?>>
                                    ...
                                    <optgroup label="<?php echo get_phrase('recept_no-_patient'); ?>">
                                        <?php  
                                            $all_info= $this->db->get_where('sendpatients',array("sendto"=>"LAB"))->result_array();
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="col-md-3 control-label"><?php echo get_phrase('laboratory_name:'); ?></label>
                            <div class="col-md-9">
                                <select required id="drug-select" name="itemcode" class="form-control " placeholder=<?php echo get_phrase('type_search_laboratory');?>>
                                    <option value=""><?php echo get_phrase('type_search_lab'); ?></option>
                                    <optgroup label="<?php echo get_phrase('laboratory_name'); ?>">
